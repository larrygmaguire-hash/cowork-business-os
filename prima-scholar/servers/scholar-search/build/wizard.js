...
// ── Query Analysis ───────────────────────────────────────────────────
function detectDisciplines(query) {
...
function suggestSources(disciplines) {
...
// ── Question Generation ──────────────────────────────────────────────
function generateQuestions(disciplines, confidence) {
    const questions = [];
    ...
    // Preprints
    const hasPreprint = disciplines.some((d) => ["neuroscience", "biomedical", "computer_science", "mathematics_physics", "economics"].includes(d));
...
function formatDisciplineLabel(d) {
    const labels = {
...
// ── Public API ───────────────────────────────────────────────────────
export function runWizard(query) {
