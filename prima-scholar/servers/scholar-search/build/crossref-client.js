...
export class CrossRefClient {
    rateLimiter = new RateLimiter(50, 1000);
    mailto;
    constructor() {
    ...
    async search(query, options) {
        ...
        return items.map((item) => this.mapToPaper(item));
    }
    /**
    ...
    mapToPaper(item) {
        ...
        const hasOaLicence = licences.some((l) => {
            const licUrl = l.URL ?? "";
...
//# sourceMappingURL=crossref-client.js.map