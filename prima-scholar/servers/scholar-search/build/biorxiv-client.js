...
export class BiorxivClient {
    ...
    async searchServer(server, query, fromDate, toDate, maxResults) {
        await this.rateLimiter.acquire();
        // The content API endpoint: /details/{server}/{from}/{to}/{cursor}
        const response = await fetch(`${BASE_URL}/details/${server}/${fromDate}/${toDate}/0/json`);
        if (!response.ok) {
...
//# sourceMappingURL=biorxiv-client.js.map