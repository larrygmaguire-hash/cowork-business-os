...
export const TOOLS = [
    {
        name: "scholar_wizard",
        description: "Analyse a research query and generate structured guidance questions before searching. " +
    ...
    {
        name: "scholar_search",
        description: "Search across multiple academic databases simultaneously. Returns deduplicated results " +
        ...
        inputSchema: {
            ...
            properties: {
                ...
                max_results: {
                    type: "number",
                    description: "Maximum results per source. Default 10. Total results may be higher before deduplication.",
                },
                sources: {
                    type: "array",
                    items: {
                    ...
                    description: "Which databases to search. Default: determined by wizard or all available. " +
                        "Specify a subset to narrow scope.",
                },
                open_access_only: {
                    type: "boolean",
                    description: "If true, only return open access papers. If false (default), return all papers " +
                ...
                citation_style: {
                    type: "string",
                    description: "Citation format: apa7, harvard, chicago, vancouver, ieee, mla. Default: all styles returned.",
    ...
    },
    {
        ...
        description: "Get full metadata for a single paper by its identifier. Accepts DOIs, PubMed IDs (PMID:xxx), " +
        ...
        inputSchema: {
            ...
            properties: {
                id: {
                    type: "string",
                    description: "Paper identifier. Formats: DOI (10.xxx/xxx), PMID:38123456, ARXIV:2301.12345, " +
    ...
    },
    {
        ...
        description: "Get papers that cite or are referenced by a given paper. Useful for forward citation " +
        ...
        inputSchema: {
            ...
            properties: {
                paper_id: {
                    type: "string",
                    description: "Paper identifier (Semantic Scholar ID, DOI:xxx, ARXIV:xxx, or PMID:xxx).",
                },
                direction: {
                    type: "string",
                    enum: ["citations", "references"],
                    description: "Direction: 'citations' for papers citing this one (forward), " +
    ...
    },
    {
        ...
        description: "Retrieve the full text of an open access paper where available. Queries CORE and Europe PMC " +
        ...
        inputSchema: {
            ...
            properties: {
                id: {
                    type: "string",
                    description: "Paper identifier — CORE ID, PMC ID, DOI, or any ID from a search result " +
