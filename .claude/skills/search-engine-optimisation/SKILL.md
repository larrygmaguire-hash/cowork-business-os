...
description: >
  Optimise web content for search engine results. Covers on-page SEO (Yoast-aligned), technical SEO audits, keyword placement, meta descriptions, schema markup, internal linking, and site structure. Use when asked to optimise for SEO, audit a page, research keywords, improve search ranking, or check technical SEO.
metadata:
  version: 1.0.0
---
...
- This skill guides keyword selection but does not have access to keyword volume tools. Recommend checking volumes in Ahrefs, SEMrush, Google Keyword Planner, or Ubersuggest.
...
2. Run technical checklist above
...
- **No focus keyword provided:** Suggest 3-5 based on page content
